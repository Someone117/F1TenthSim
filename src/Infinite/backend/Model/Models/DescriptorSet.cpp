...
namespace Infinite {
    DescriptorSet::DescriptorSet(VkDevice device, std::vector<BufferAlloc> uniformBuffers, VkImageView textureView, VkSampler textureSampler) {
    ...
    void DescriptorSet::createDescriptorSetLayout(VkDevice device) {
